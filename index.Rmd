...
Apresar da sala onde será ministrado contenha computadores com os programas já instalados, que quiser utilizar seu prórpio computador será muito bem vindo. Nesse caso, sugerimos instalar tanto o **R** quanto o **RStudio**. Para isso, entre na aula **Conceitos Básicos em R** e siga as intruções de instalação.
