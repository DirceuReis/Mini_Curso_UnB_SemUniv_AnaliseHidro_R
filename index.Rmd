...
Este mesmo curso deve ser replicado mais vezes no futuro próximo. Os alunos que venham a fazer este curso irão aprender como utilizar a linguagem R para executar um conjunto de atividades que permitirão realizar uma análise de frequência de cheias para uma estação fluviométrica, cujos dados serão automaticamente obtidos do webservice da Agência Nacional de Águas. 
...
## Datas previstas e realizações anteriores

### Próxima realização do curso
