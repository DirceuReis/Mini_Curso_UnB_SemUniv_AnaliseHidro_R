...
Além de construirmos a relação entre a magnitude das vazões máximas anuais e a respectiva probabilidade de excedência, é importante saber estimar também o grau de incerteza nessas estimativas. Essas incertezas são usualmente reprsentadas por intervalos de confiança, como veremos mais adianate. 

Além de calcular essas quantidades, normalmente a curva de frequência, e suas respectivas incertezas, são representadas graficamente, como na figura abaixo, que mostra os resultados para um estudo de cheias numa seção do Rio Salado, localizada na província de Santa Fé, na Argentina, onde em 2003 ocorreu o rompimento de um dique que resultou em mortes e elevados prejuízos.  
...
Nós utilizaremos aqui a mesma função que utilizamos na segunda aula do curso para obter os dados de vazão. No nosso caso, vamos focar num primeiro momento na estação "60435000", localizada na bacia do Rio Descoberto, que drena uma área de $113.2$ km^2.
...
Depois de obter a séries de vazões diárias da estação desejada, precisamos agora construir a série de máximos anuais com base no ano hidrológico da estação. Para isso, utilizaremos a função aprsentada abaixo,
...
Basta chamar a função fornecendo o arquivo que contém as séries diárias de vazão.

```{r}
# Teste da função
serie_600435000 <- fun_max_ano(dados_60435000)
