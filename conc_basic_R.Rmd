...
A função c() é usada para concatenar valores, criando vetores de valores da mesma `classe`. Falaremos mais especificamente de `classe`mias à frente.
...
Veja que o *R* aceita trocar trocar a direção da seta, mas ela sempre deve apontar para o nome do objeto que vai receber o valor, como no exmeplo abaixo,
